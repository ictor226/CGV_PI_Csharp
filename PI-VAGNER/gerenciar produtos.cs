        ...
        private void buttonPesquisarClientes_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (MySqlConnection consulta = new MySqlConnection(conectionString))
                {
                    ...
                    consulta.Open();
                    string listagem = "SELECT id_produto , nome_item, preco_item, parcelamento, versao, descricao, ano_lancamento, quantidade, img_produto1, img_produto2, img_produto3 FROM cadastro_produto";
